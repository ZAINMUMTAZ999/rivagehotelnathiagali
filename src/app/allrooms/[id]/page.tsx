        ...
        <div className="bg-white rounded-lg shadow-xl overflow-hidden">
          <div className="">
            ...
            <Link
              ...
              className="flex justify-center items-center w-full   hover:cursor-pointer bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg transition-colors duration-200 shadow-sm hover:shadow-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
            >
              Book Now Pay Later
            </Link>
