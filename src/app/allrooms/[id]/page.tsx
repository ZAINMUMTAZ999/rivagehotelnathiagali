...
const MyHotelsById = () =>
  ...
  const whatsappUrl = `https://wa.me/923289330350?text=${encodeURIComponent(
    ...
    return (
      ...
      <div className="mt-8">
       ...
       <Link href={whatsappUrl} target="_blank" rel="noopener noreferrer">
                <Button className="flex justify-center items-center w-full cursor-pointer  hover:cursor-pointer bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg transition-colors duration-200 shadow-sm hover:shadow-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">
        Book Now Pay Later
                </Button>
      </Link>
