    ...
    return (
      ...
      <div className="text-center">
        ...
        <p className="text-lg sm:text-xl md:text-2xl text-gray-700 mb-8">
          The page you are looking for needs refresh.
        </p>
        <Link href="/">
            ...
            <div className="p-5 sm:p-6 flex-grow flex flex-col justify-between">
              ...
              <div className="flex justify-end mt-4 pt-4 border-t border-gray-100">
                <Link
                  ...
                  className="bg-blue-600 hover:bg-blue-700 text-white text-sm sm:text-base font-bold py-2 px-4 rounded-lg 
                  
                 
                   transition-colors duration-200 shadow-md transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 hover:cursor-pointer"
                >
                  View Details
                </Link>
              </div>
