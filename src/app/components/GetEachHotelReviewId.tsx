...
import { GetReviewEachHotelById } from "../Api";
...
export const GetEachHotelReviewId = ({ hotelId }: { hotelId: string }) => {
  const [selectedReview, setSelectedReview] = useState<AddReviewTypesId | null>(null);
// const { hotelId } = useParams<{ hotelId: string }>();

const { data: reviewsData, isLoading, isError, error } = useQuery<AddReviewTypesId[], Error>({
  queryKey: ["getReviewsByID", hotelId],        // include hotelId in the key
  queryFn: () => GetReviewEachHotelById(hotelId),
  enabled: Boolean(hotelId),   

});
console.log("HotelReviewById",reviewsData);
