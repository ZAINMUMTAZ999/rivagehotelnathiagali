...
export default function ContactUS() {
  ...
  return (
    <main className="w-full bg-white relative overflow-hidden">
      ...
      {/* Main Container */}
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 md:px-8 py-8 sm:py-10 md:py-12 lg:py-14">
        <div className="flex flex-col lg:flex-row items-start justify-between gap-8 sm:gap-10 lg:gap-14 xl:gap-20">

          {/* Contact Information */}
          <div className="w-full lg:w-5/12 text-center lg:text-left lg:pt-6">
            <div className="mb-7 sm:mb-8">
              ...
              <p className="text-gray-600 text-sm sm:text-base md:text-lg max-w-md mx-auto lg:mx-0 leading-relaxed">
                Have a project in mind or just want to say hi? We would love
                to hear from you!
              </p>
            </div>
          ...
          <form
            onSubmit={onSubmits}
            className="w-full lg:w-7/12 bg-white p-5 sm:p-6 md:p-8 lg:p-9 rounded-2xl shadow-2xl"
          >
            {/* Form Header */}
