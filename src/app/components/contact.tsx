   ...
   mzainmumtaz99@gmail.com
        ...
        className="w-full lg:w-7/12 bg-white p-6 sm:p-8 lg:p-10 rounded-2xl shadow-2xl">
          ...
          <div className="space-y-6">
            ...
            <Button type="submit" 
            disabled={isLoading}
             className="w-full py-3 text-base font-semibold bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-all duration-300 shadow-md hover:shadow-lg disabled:bg-gray-400 disabled:cursor-not-allowed hover:cursor-pointer">
